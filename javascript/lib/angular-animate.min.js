...
(function(S, m) {
    ...
    function W(a, b, c) {
        var d = "";
        a = V(a) ? a : a && B(a) && a.length ? a.split(/\s+/) : [];
        t(a, function(a, e) {
            a &&
                0 < a.length &&
                ((d += 0 < e ? " " : ""), (d += c ? b + a : a + b));
    ...
    function T(a, b, c) {
        var d = b.options || {};
        c = c.options || {};
        var g = (d.addClass || "") + " " + (c.addClass || ""),
            e = (d.removeClass || "") + " " + (c.removeClass || "");
        a = Ta(a.attr("class"), g, e);
        c.preparationClasses &&
            ((d.preparationClasses = ca(
                c.preparationClasses,
                d.preparationClasses
            )),
            delete c.preparationClasses);
        g = d.domOperation !== O ? d.domOperation : null;
        va(d, c);
        g && (d.domOperation = g);
    ...
    function Ta(a, b, c) {
        ...
        t(g, function(b, c) {
            var d, g;
            1 === b
                ? ((d = "addClass"), (g = !a[c] || a[c + "-remove"]))
                : -1 === b &&
                  ((d = "removeClass"), (g = a[c] || a[c + "-add"]));
            g && (e[d].length && (e[d] += " "), (e[d] += c));
        });
        return e;
    }
    function I(a) {
                ...
                return {
                    link: function(b, c, d) {
                        ...
                        B(e) && 0 === e.length
                            ...
                            : (g(a(e)(b)), d.$observe("ngAnimateChildren", g));
                    }
                };
            }
        ])
        ...
        .provider("$$animateQueue", [
            ...
            function(a) {
                ...
                this.$get = [
                    ...
                    "$$forceReflow",
                    "$$isDocumentHidden",
                    function(b, c, e, l, J, sa, da, v, E, h, L) {
                        function x() {
                            var a = !1;
                            return function(b) {
                                a
                        ...
                        function p(a, k, w) {
                            ...
                            h.addClass && !B(h.addClass) && (h.addClass = null);
                            V(h.removeClass) &&
                                (h.removeClass = h.removeClass.join(" "));
                            h.removeClass &&
                                !B(h.removeClass) &&
                                (h.removeClass = null);
                            h.from && !ra(h.from) && (h.from = null);
                            h.to && !ra(h.to) && (h.to = null);
                            if (!(f && q && Ya(q, k, w) && D(q, h)))
                                return H(), l;
                        ...
                        function ta(a) {
                            ...
                            t(a, function(a) {
                                var b = parseInt(
                                        a.getAttribute("data-ng-animate"),
                                        10
                                    ),
                                    c = y.get(a);
                                if (c)
                        ...
                        function K(a, b, c) {
                            ...
                            for (
                                ...
                                if (P(C) || !0 === C)
                                    (a = z.data(b, "$$ngAnimateChildren")),
                                        ya(a) && (C = a);
                                if (h && !1 === C) break;
                                d || (d = b === c);
                                if (d && k) break;
                                if (!k && (a = z.data(b, "$ngAnimatePin"))) {
                                    b = I(a);
                                    continue;
                                }
                                b = b.parentNode;
                        ...
                        var Ya = J || h,
                            ...
                            ba = {
                                on: function(a, b, c) {
                                    var f = ua(b);
                                    k[a] = k[a] || [];
                                    k[a].push({ node: f, callback: c });
                                    z(b).on("$destroy", function() {
                                        y.get(f) || ba.off(a, b, c);
                                    });
                                },
                                off: function(a, b, c) {
                                    if (
                ...
                this.$get = [
                    ...
                    function(a, d, g, e, r, G) {
                        ...
                        return function(r, m, v) {
                            ...
                            function H() {
                                var a = r.data("$$animationRunner");
                                !a ||
                                    ("leave" === m && v.$$domOperationFired) ||
                                    a.end();
                            }
                            function p(b) {
                                r.off("$destroy", H);
                                r.removeData("$$animationRunner");
                                J(r, v);
                                ha(r, v);
                                v.domOperation();
                                F && a.removeClass(r, F);
                                r.removeClass("ng-animate");
                                n.complete(!b);
                            }
                            v = oa(v);
                            var ta = 0 <= ["enter", "move", "leave"].indexOf(m),
                                n = new e({
                                    end: function() {
                                        p();
                                    },
                            ...
                            if (!b.length) return p(), n;
                            r.data("$$animationRunner", n);
                            var K = Fa(
                                    r.attr("class"),
                                    Fa(v.addClass, v.removeClass)
                                ),
                                F = v.tempClasses;
                            F && ((K += " " + F), (v.tempClasses = null));
                            var y;
                            ta &&
                                ((y = "ng-" + m + "-prepare"),
                                a.addClass(r, y));
                            l.push({
                                ...
                                beforeStart: function() {
                                    ...
                                    F && a.addClass(r, F);
                                    y && (a.removeClass(r, y), (y = null));
                                },
                                close: p
                            });
                            r.on("$destroy", H);
                            if (1 < l.length) return n;
                            d.$$postDigest(function() {
                                var a = [];
                                t(l, function(b) {
                                    b.element.data("$$animationRunner")
                                        ? a.push(b)
                                        : b.close();
                                });
                                l.length = 0;
                                ...
                                t(b, function(a) {
                                    c.push({
                                        domNode: I(
                                            a.from ? a.from.element : a.element
                                        ),
                                        fn: function() {
                                            a.beforeStart();
                                            var b,
        ...
        .provider("$animateCss", [
            ...
            function(a) {
                ...
                this.$get = [
                    ...
                    "$$rAFScheduler",
                    "$$animateQueue",
                    function(a, g, e, r, G, N, l, J) {
                        function m(a, b) {
                            var c = a.parentNode;
                            return (
                                (c.$$ngAnimateParentKey ||
                                    (c.$$ngAnimateParentKey = ++L)) +
                                "-" +
                                a.getAttribute("class") +
                                "-" +
                                b
                        ...
                        function da(h, e, p, r) {
                            ...
                            0 < b.count(p) &&
                                ...
                                n ||
                                    ...
                                    g.addClass(h, e),
                                    (n = Ja(a, h, r)),
                                    (n.animationDuration = Math.max(
                                        n.animationDuration,
                                        0
                                    )),
                                    (n.transitionDuration = Math.max(
                        ...
                        return function(a, c) {
                            ...
                            function n(b) {
                                if (!(L || (ba && u))) {
                                    ...
                                    Object.keys(q).length &&
                                        t(q, function(a, b) {
                                            a
                                                ? k.style.setProperty(b, a)
                                                : k.style.removeProperty(b);
                                        });
                            ...
                            function K(a) {
                                s.blockTransition && pa(k, a);
                                s.blockKeyframeAnimation && wa(k, !!a);
                            }
                            function F() {
                                z = new e({ end: d, cancel: l });
                                v(O);
                                n();
                                return {
                                    $$willAnimate: !1,
                                ...
                                function b() {
                                    if (!L) {
                                        ...
                                        if (s.recalculateTimingStyles) {
                                            ...
                                            s.hasTransitions =
                                                0 < A.transitionDuration;
                                            s.hasAnimations =
                                                0 < A.animationDuration;
                                        }
                                        s.applyAnimationDelay &&
                                            (($ =
                                                "boolean" !== typeof f.delay &&
                                                xa(f.delay)
                                                    ? parseFloat(f.delay)
                                                    : $),
                                            (w = Math.max($, 0)),
                                        ...
                                        A.transitionDuration && ea.push(za);
                                        A.animationDuration && ea.push(Aa);
                                        T = Date.now();
                                        var l = P + 1.5 * S;
                                        d = T + l;
                            ...
                            var f = c || {};
                            f.$$prepared || (f = oa(Ca(f)));
                            var q = {},
                                k = I(a);
                            if (!k || !k.parentNode || !J.enabled()) return F();
                            var x = [],
                                G = a.attr("class"),
                                D = Qa(f),
                                L,
                            ...
                            ia && f.structural
                                ? (X = W(ia, "ng-", !0))
                                : ia && (X = ia);
                            f.addClass && (R += W(f.addClass, "-add"));
                            f.removeClass &&
                                (R.length && (R += " "),
                                (R += W(f.removeClass, "-remove")));
                            f.applyClassesEarly && R.length && h(a, f);
                            var fa = [X, R].join(" ").trim(),
                                ma = G + " " + fa,
                                ca = W(fa, "-active"),
                                G = D.to && 0 < Object.keys(D.to).length;
                            if (
                                !(0 < (f.keyframeStyle || "").length || G || fa)
                            )
                                return F();
                            var ja, U;
                            0 < f.stagger
                                ? ((D = parseFloat(f.stagger)),
                                  (U = {
                                      transitionDelay: D,
                                      animationDelay: D,
                                ...
                                : ((ja = m(k, ma)), (U = da(k, fa, ja, Xa)));
                            f.$$skipPreparationClasses || g.addClass(a, fa);
                            f.transitionStyle &&
                                ((D = [Q, f.transitionStyle]),
                                ka(k, D),
                                x.push(D));
                            0 <= f.duration &&
                            ...
                            var Z = U
                                ? 0 <= f.staggerIndex
                                    ...
                                    : b.count(ja)
                                : 0;
                            (ia = 0 === Z) && !f.skipBlocking && pa(k, 9999);
                            var A = E(k, ma, ja),
                                $ = A.maxDelay;
                            w = Math.max($, 0);
                            M = A.maxDuration;
                            ...
                            s.hasAnimations = 0 < A.animationDuration;
                            s.hasTransitionAll =
                                s.hasTransitions &&
                                "all" === A.transitionProperty;
                            s.applyTransitionDuration =
                                G &&
                                ((s.hasTransitions && !s.hasTransitionAll) ||
                                    (s.hasAnimations && !s.hasTransitions));
                            s.applyAnimationDuration =
                                f.duration && s.hasAnimations;
                            s.applyTransitionDelay =
                                xa(f.delay) &&
                                (s.applyTransitionDuration || s.hasTransitions);
                            s.applyAnimationDelay =
                                xa(f.delay) && s.hasAnimations;
                            s.recalculateTimingStyles = 0 < R.length;
                            if (
                                s.applyTransitionDuration ||
                                s.applyAnimationDuration
                            )
                                (M = f.duration ? parseFloat(f.duration) : M),
                                    s.applyTransitionDuration &&
                                        ((s.hasTransitions = !0),
                                        (A.transitionDuration = M),
                                        (D =
                                            0 < k.style[Q + "Property"].length),
                                        x.push(Ka(M, D))),
                                    s.applyAnimationDuration &&
                                        ((s.hasAnimations = !0),
                                        (A.animationDuration = M),
                                        x.push([Ba, M + "s"]));
                            if (0 === M && !s.recalculateTimingStyles)
                                return F();
                            if (null != f.delay) {
                                var aa;
                                "boolean" !== typeof f.delay &&
                                    ((aa = parseFloat(f.delay)),
                                    (w = Math.max(aa, 0)));
                                s.applyTransitionDelay &&
                                    x.push([la, aa + "s"]);
                                s.applyAnimationDelay && x.push([qa, aa + "s"]);
                            }
                            null == f.duration &&
                                0 < A.transitionDuration &&
                                (s.recalculateTimingStyles =
                                    s.recalculateTimingStyles || ia);
                            P = 1e3 * w;
                            S = 1e3 * M;
                            f.skipBlocking ||
                                ((s.blockTransition = 0 < A.transitionDuration),
                                (s.blockKeyframeAnimation =
                                    0 < A.animationDuration &&
                                    0 < U.animationDelay &&
                                    0 === U.animationDuration));
                            f.from &&
                                (f.cleanupStyles &&
                                    Ma(q, k, Object.keys(f.from)),
                                Ha(a, f));
                            s.blockTransition || s.blockKeyframeAnimation
                                ? K(M)
                                : f.skipBlocking || pa(k, !1);
                            return {
                                $$willAnimate: !0,
                                end: d,
                                start: function() {
                ...
                this.$get = [
                    ...
                    function(a, c, d, g, e, r, G) {
                        ...
                        function J(c, e, g) {
                            function r(a) {
                                var b = {},
                                    c = I(a).getBoundingClientRect();
                                t(["width", "height", "top", "left"], function(
                                    a
                                ) {
                                    var d = c[a];
                                    switch (a) {
                        ...
                        function da(c) {
                            ...
                            c.structural &&
                                ...
                                "leave" === c.event &&
                                    (e.onDone = e.domOperation));
                            e.preparationClasses &&
                                (e.event = ca(e.event, e.preparationClasses));
                            c = a(d, e);
                            return c.$$willAnimate ? c : null;
                        }
                        if (!e.animations && !e.transitions) return O;
                        var v = G[0].body;
                        c = I(g);
                        var E = z(
                            (c.parentNode && 11 === c.parentNode.nodeType) ||
                            v.contains(c)
                                ? c
                                : v
                        );
                        return function(a) {
                            return a.from && a.to
                                ? m(a.from, a.to, a.classes, a.anchors)
                                : da(a);
                        };
                    }
                ];
                    ...
                    function(b, c, d) {
                        function g(c) {
                            ...
                            for (var d = [], e = {}, g = 0; g < c.length; g++) {
                                var m = c[g],
                                    t = a.$$registeredAnimations[m];
                                t && !e[m] && (d.push(b.get(t)), (e[m] = !0));
                            }
                            return d;
                        }
                        var e = X(d);
                        return function(a, b, d, l) {
                            ...
                            d ||
                                ((d = a.attr("class") || ""),
                                l.addClass && (d += " " + l.addClass),
                                l.removeClass && (d += " " + l.removeClass));
                            var h = l.addClass,
                                L = l.removeClass,
                                x = g(d),
                                C,
